...
[MAC_BASE] = LAYOUT_ansi_84(
     ...
     LT(CAPS_LAYER, KC_CAPS),  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,            KC_ENT,             KC_HOME,
...
[WIN_FN] = LAYOUT_ansi_84(
     ...
     BL_TOGG,  BL_STEP,  BL_UP,    KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,
     KC_TRNS,  KC_TRNS,  BL_DOWN,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,            KC_TRNS,
     SC_LSPO,            KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  BAT_LVL,  NK_TOGG,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,            KC_TRNS,  KC_TRNS,  KC_TRNS,
     KC_TRNS,  KC_TRNS,  KC_TRNS,                                KC_TRNS,                                KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS),

[CAPS_LAYER] = LAYOUT_ansi_84(
...
enum combos {
    ...
    CTRL_LGUI_RIGHT_END,
    CTRL_LGUI_UP_PGUP,
    CTRL_LGUI_DOWN_PGDOWN,
};

const uint16_t PROGMEM cgl_combo[] = {KC_LCTL, KC_LGUI, KC_LEFT, COMBO_END};
const uint16_t PROGMEM cgr_combo[] = {KC_LCTL, KC_LGUI, KC_RIGHT, COMBO_END};
const uint16_t PROGMEM cgu_combo[] = {KC_LCTL, KC_LGUI, KC_UP, COMBO_END};
const uint16_t PROGMEM cgd_combo[] = {KC_LCTL, KC_LGUI, KC_DOWN, COMBO_END};

combo_t key_combos[] = {
    [CTRL_LGUI_LEFT_HOME] = COMBO(cgl_combo, KC_HOME),
    [CTRL_LGUI_RIGHT_END] = COMBO(cgr_combo, KC_END),
    [CTRL_LGUI_UP_PGUP] = COMBO(cgu_combo, KC_PAGE_UP),
    [CTRL_LGUI_DOWN_PGDOWN] = COMBO(cgd_combo, KC_PAGE_DOWN),
};
